# Final QA Report — prunify v0.1.0
...
| 4 | `prunify --version` | ✅ PASS | Shows "prunify 0.1.0" |
...
| 13 | `prunify --scheme-dir .prunify/schemes --no-mark ls -la` | ✅ PASS | Works with explicit scheme dir |
...
| [8] | --version — shows prunify 0.1.0 | ✅ PASS |
